...
<html>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u511" class="ax_default" data-label="Text Field &amp; Labels (Outlined)" data-left="641" data-top="355" data-width="300" data-height="47">

        <!-- Input Field (Text Field) -->
        <div id="u512" class="ax_default text_field" data-label="Input Field">
          <div id="u512_div" class=""></div>
          <input id="u512_input" type="text" value="" class="u512_input"/>
        </div>

        <!-- Input Label (Rectangle) -->
        <div id="u513" class="ax_default label" data-label="Input Label">
      ...
      <!-- Text Field & Labels (Outlined) (Group) -->
      <div id="u514" class="ax_default" data-label="Text Field &amp; Labels (Outlined)" data-left="641" data-top="433" data-width="300" data-height="47">

        <!-- Input Field (Text Field) -->
        <div id="u515" class="ax_default text_field" data-label="Input Field">
          <div id="u515_div" class=""></div>
          <input id="u515_input" type="text" value="" class="u515_input"/>
        </div>

        <!-- Input Label (Rectangle) -->
        <div id="u516" class="ax_default label" data-label="Input Label">
      ...
      <!-- Text Field & Labels (Outlined) (Group) -->
      <div id="u517" class="ax_default" data-label="Text Field &amp; Labels (Outlined)" data-left="641" data-top="511" data-width="300" data-height="47">

        <!-- Input Field (Text Field) -->
        <div id="u518" class="ax_default text_field" data-label="Input Field">
          <div id="u518_div" class=""></div>
          <input id="u518_input" type="text" value="" class="u518_input"/>
        </div>

        <!-- Input Label (Rectangle) -->
        <div id="u519" class="ax_default label" data-label="Input Label">
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u520" class="ax_default primary_button1">
