...
<html>
  <head>
    ...
    <script src="files/sign_up_-_refugee_1/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u71" class="ax_default" data-label="Navigation Bar" data-left="0" data-top="0" data-width="1500" data-height="152">
        ...
        <!-- Menu Bar (Rectangle) -->
        <div id="u72" class="ax_default shape" data-label="Menu Bar">
      ...
      <div id="u74" class="ax_default icon">
        <img id="u74_img" class="img " src="images/sign_up_-_selection_between_refugee_and_student/u41.svg"/>
      ...
      <div id="u75" class="ax_default icon">
        <img id="u75_img" class="img " src="images/sign_up_-_selection_between_refugee_and_student/u42.svg"/>
      ...
      <div id="u76" class="ax_default icon">
        <img id="u76_img" class="img " src="images/sign_up_-_selection_between_refugee_and_student/u43.svg"/>
      ...
      <div id="u77" class="ax_default icon">
        <img id="u77_img" class="img " src="images/sign_up_-_selection_between_refugee_and_student/u44.svg"/>
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u84" class="ax_default link_button">
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u85" class="ax_default link_button">
      ...
      <div id="u88" class="ax_default icon">
        <img id="u88_img" class="img " src="images/home/u27.svg"/>
      ...
      <div id="u90" class="ax_default image">
        <img id="u90_img" class="img " src="images/home/u29.png"/>
