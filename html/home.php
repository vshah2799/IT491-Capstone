...
<html>
  ...
  <body>
    <div id="base" class="">
      ...
      <!-- Unnamed (Image) -->
      <div id="u0" class="ax_default image ax_default_hidden" style="display:none; visibility: hidden">
      ...
      <div id="u1" class="ax_default" data-label="Navigation Bar" data-left="0" data-top="0" data-width="1500" data-height="126">
        ...
        <!-- Account Icon (Shape) -->
        <div id="u3" class="ax_default icon" data-label="Account Icon">
          <img id="u3_img" class="img " src="images/home/account_icon_u3.svg"/>
      ...
      <div id="u7" class="ax_default heading_1">
        ...
        <div id="u7_text" class="text ">
          <p><span>We help refugees connect with students in their new communities so they can alleviate some of the issues they experience with their changed lives.</span></p>
        </div>
      </div>
      ...
      <div id="u16" class="ax_default heading_1">
        ...
        <div id="u16_text" class="text ">
          <p><span>Education for Refugees</span></p>
        </div>
      </div>
      ...
      <!-- Unnamed (Image) -->
      <div id="u19" class="ax_default image ax_default_hidden" style="display:none; visibility: hidden">
        <img id="u19_img" class="img " src="images/home/u19.svg"/>
      ...
      <!-- Unnamed (Image) -->
      <div id="u20" class="ax_default image ax_default_hidden" style="display:none; visibility: hidden">
      ...
      <!-- Unnamed (Rectangle) -->
      <div id="u23" class="ax_default link_button">
      ...
      <div id="u27" class="ax_default icon">
        <img id="u27_img" class="img " src="images/home/u27.svg"/>
